...
//            {"cancel", "cancels the action you are in"} TODO
    ...
    public static void main(String[] args) {
        int bestMatchIndex = findMatch("buuy animals", createListVectors(command_vector_list));
        System.out.println(command_vector_list[bestMatchIndex]);

        bestMatchIndex = findMatch("buuy animals", createListVectors(command_vector_list));
        System.out.println(command_vector_list[bestMatchIndex]);
    }
}
