...
public class Reader {
    ...
    private void save_reader(String file_path, UserInterface UI) throws IOException {
    ...
    private void getAnimalsFromLine(String line) {
    ...
    private void addAnimal(String species_name, String name) {
        Animals animal = null;
        switch (species_name) {
            case "flamingo":
